...
if ( NOT DEFINED GVDB_ROOT_DIR )
  if (WIN32)
    get_filename_component ( BASEDIR "${CMAKE_MODULE_PATH}/../.." REALPATH )
  else()
...
if ( GVDB_ROOT_DIR )
	...
	#if ( (OK_PTX EQUAL 2) AND (OK_GLSL GREATER_EQUAL 3) ) 
	...
	#-------- Locate Support DLLs
        set ( OK_EXTRA "0" )		
	_FIND_MULTIPLE ( LIST_EXTRA GVDB_LIB_DIR "dll" "" OK_EXTRA )	
